# Algorithm 7, Page 16 — Gale-Shapley Stable Marriage
# Label: alg:gale-shapley
# An Introduction to the Analysis of Algorithms (4th Edition)
#
# Matchmaking algorithm for disjoint sets of size n.
#
# Input: file containing 2n preference lists, each of length n.
# Lines 0..n-1: first group's preferences for matches in the second.
# Lines n..2n-1: second group's preferences for the first.
#
# Usage: python A7_Gale-Shapley.py input_A7_Gale-Shapley.txt
